...
videogames.filter((videogame) => videogame.genders === "RPG")

const newVideo = videogames.map((videogame)=> videogame.score)
console.log(newVideo)
const newVideo1 = newVideo.reduce((a1,b1) => (a1+b1/newVideo.length),0)
console.log(`La media de los juegos con categoria RPG es de ${newVideo1}`)